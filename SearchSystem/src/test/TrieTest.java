...
public class TrieTest {
	...
	public void mainTest() {
		...
		System.out.println("####################################");
		System.out.println("Iniciando Teste da inser��o");
		t.trieTest();
		System.out.println("####################################");
		System.out.println("Iniciando busca por come�o de palvra");
		t.testGetWords();
		System.out.println("####################################");
	}
	...
	public void trieTest() {
		...
		System.out.println("remo��o de larissa do grupo " + (w.search("larissa") == null ? "funfou" : "bugou"));
		w.remove("testes");
		System.out.println("remo��o de testes " + (w.search("testes") == null ? "funfou" : "bugou"));
		w.remove("empresa");
		System.out.println("remo��o de empresa " + (w.search("empresa") == null ? "funfou" : "bugou"));
		w.remove("e");
		System.out.println("remo��o de e " + (w.search("e") == null ? "funfou" : "bugou"));
		...
		w.insert("empresa", null, null, null);
		System.out.println(
				"verificando nova inser��o da palavra empresa " + (w.search("empresa") != null ? "funfou" : "bugou"));
		w.insert("e", null, null, null);
		System.out.println("verificando nova inser��oo da palavra e " + (w.search("e") != null ? "funfou" : "bugou"));
