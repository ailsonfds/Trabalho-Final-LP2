...
public class IndexerTest {
	...
	public void indexerTest() {
		...
		String word1 = "google";
		String word2 = "come鏾u";
		String word3 = "Calif髍nia";
		String word4 = "N鷐ero site miss鉶";
		String word5 = "e";
		
		System.out.println("#### INSER敲O TESTE ####");
		try {
		...
		try {
			...
			System.out.println("N鉶 encontrou " + word1 + " em busca OR");
		}		
		try {
		...
		try {
			...
			System.out.println("N鉶 encontrou " + word2 + " em busca OR");
		}
		try {
			printSearchResult(index.searchOR(word3));
		} catch (EmptyWordException | EmptySearchException | BlackListException e) {
			System.out.println("N鉶 encontrou " + word3 + " em busca OR");
		}
		try {
			printSearchResult(index.searchOR(word4));
		} catch (EmptyWordException | EmptySearchException | BlackListException e) {
			System.out.println("N鉶 encontrou " + word4 + " em busca OR");
		}
		try {
			printSearchResult(index.searchOR("blabla"));
		} catch (EmptyWordException | EmptySearchException | BlackListException e) {
			System.out.println("N鉶 encontrou blabla em busca OR");
		}

		try {
			printSearchResult(index.searchAND(word1));
		} catch (EmptyWordException | EmptySearchException | BlackListException e) {
			System.out.println("N鉶 encontrou " + word1 + " em busca AND");
		}
		try {
		...
		try {
			...
			System.out.println("N鉶 encontrou " + word2 + " em busca AND");
		}
		try {
			printSearchResult(index.searchAND(word3));
		} catch (EmptyWordException | EmptySearchException | BlackListException e) {
			System.out.println("N鉶 encontrou " + word3 + " em busca AND");
		}
		try {
			printSearchResult(index.searchAND(word4));
		} catch (EmptyWordException | EmptySearchException | BlackListException e) {
			System.out.println("N鉶 encontrou " + word4 + " em busca AND");
		}
		try {
			printSearchResult(index.searchAND("blabla"));
		} catch (EmptyWordException | EmptySearchException | BlackListException e) {
			System.out.println("N鉶 encontrou blabla em busca AND");
		}
		try {
			printSearchResult(index.searchAND("lacinia"));
		} catch (EmptyWordException | EmptySearchException | BlackListException e) {
			System.out.println("N鉶 encontrou lacinia em busca AND");
		}
		...
		try {
			printSearchResult(index.searchOR("sex er贸tico"));
		} catch (EmptyWordException | EmptySearchException | BlackListException e) {
			System.out.println(e);
		}

		try {
			printSearchResult(index.searchOR("sex er贸tico Google"));
		} catch (EmptyWordException | EmptySearchException | BlackListException e) {
			System.out.println(e);
		}
		try {
		...
		try {
			printSearchResult(index.searchAND("sex er贸tico"));
		} catch (EmptyWordException | EmptySearchException | BlackListException e) {
			System.out.println(e);
		}
		try {
			printSearchResult(index.searchAND("sex er贸tico Google"));
		} catch (EmptyWordException | EmptySearchException | BlackListException e) {
			System.out.println(e);
		}
		...
		System.out.println("#### REMO脟脙O TESTE ####");
		try {
